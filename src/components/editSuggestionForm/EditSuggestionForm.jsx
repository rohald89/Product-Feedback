...
import { updateFeedback, deleteFeedback } from "../../app/feedbackSlice"
  ...
  return (
    <form className="bg-white rounded-[10px] space-y-6 p-6 mt-12 relative md:p-10" onSubmit={formik.handleSubmit}>
        ...
        <fieldset className="space-y-8">
            <legend className="text-md text-darkBlue font-bold">Editing '{feedback.title}'</legend>
            ...
            <div className="flex flex-col space-y-4 pt-6 md:flex-row-reverse md:space-y-0 md:gap-4">
                ...
                <button className="bg-darkBlue text-white text-sm font-bold py-3 px-6 rounded-[10px] transition hover:bg-darkBlue-hover" onClick={() => navigate('/')}>Cancel</button>
                <button
