const Header = ({isOpen, toggleNav}) => {
  return (
    <header className="flex h-full justify-between text-white py-4 px-6 bg-mobile-header bg-no-repeat bg-cover md:bg-tablet-header md:p-6 lg:bg-desktop-header md:rounded-[10px]">
