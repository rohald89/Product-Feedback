...
const SingleSuggestion = ({feedback}) => {
  ...
  return (
        <div className="grid grid-cols-2 gap-4 bg-white rounded-[10px] p-6 md:flex md:items-center">
            <Link to={`/suggestions/${id}`} className="col-span-2 flex flex-col items-start space-y-2 md:flex-1">
            ...
            <button className="flex items-center place-self-start space-x-2 bg-grey px-4 py-2 font-bold text-body-sm  rounded-[10px] md:-order-1 md:flex-col md:items-center md:space-x-0 md:space-y-2 md:mr-10 hover:bg-grey-hover">
