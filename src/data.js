    ...
    comments: [
      {
        ...
        user: {
          image: "/img/user-images/image-suzanne.jpg",
          name: "Suzanne Chang",
          username: "upbeat1811",
        },
        replies: [],
      },
      {
        ...
        user: {
          image: "/img/user-images/image-thomas.jpg",
          name: "Thomas Hood",
    ...
    comments: [
      {
        ...
        user: {
          image: "/img/user-images/image-george.jpg",
    ...
    comments: [
      {
        ...
        user: {
          image: "/img/user-images/image-javier.jpg",
          name: "Javier Pollard",
      ...
      },
      {
        ...
        user: {
          image: "/img/user-images/image-roxanne.jpg",
          name: "Roxanne Travis",
    ...
    comments: [
      {
        ...
        user: {
          image: "/img/user-images/image-victoria.jpg",
          name: "Victoria Mejia",
      ...
      },
      {
        ...
        user: {
          image: "/img/user-images/image-jackson.jpg",
          name: "Jackson Barker",
